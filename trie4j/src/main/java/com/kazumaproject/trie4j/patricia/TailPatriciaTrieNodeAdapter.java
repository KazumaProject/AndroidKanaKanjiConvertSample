...
public class TailPatriciaTrieNodeAdapter implements com.kazumaproject.trie4j.Node{
	...
	@Override
	public com.kazumaproject.trie4j.Node getChild(char c) {
		TailPatriciaTrieNode n = node.getChild(c);
		if(n == null) return null;
		else return new TailPatriciaTrieNodeAdapter(n, tails);
	}
	@Override
	public com.kazumaproject.trie4j.Node[] getChildren() {
		TailPatriciaTrieNode[] children = node.getChildren();
		if(children == null) return null;
		com.kazumaproject.trie4j.Node[] ret = new com.kazumaproject.trie4j.Node[children.length];
